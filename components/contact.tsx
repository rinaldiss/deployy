  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-6 dark:text-white/80">
        Do you have any questions or want to discuss a project or collaboration? 
        I’m excited to hear your ideas and ready to help bring them to life!
        <br />
        <br />
        You can reach out by filling out the form below. Whether it’s planning a new project, 
        sharing inspiration, or simply asking a question, I’ll respond as soon as possible and am ready to assist you.
        <br />
        <br />
        Let’s start the conversation and see what we can create together! 🚀
      </p>
