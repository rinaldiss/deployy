...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Rinaldi Saragih.</span>
      </motion.h1>
      <motion.h4
        ...
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">IT</span> Enthusiast | Ex - IT Support Intern at {" "}
        <span className="font-bold">Telkomsel</span> | Undergraduate Information Technology Student at Telkom University.
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/rinaldisaragih/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:rinaldisrgh19@gmail.com"
          target="_blank"
        >
          <RiMailSendLine />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/rinaldiss"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/rinaldsr_/"
          target="_blank"
        >
          <BsInstagram />
        </a>
